...
public class SpostaLottoControllerBase extends DialogControllerBase<FieldData> {
    private static final Logger log = LoggerFactory.getLogger(SpostaLottoControllerBase.class);
    ...
    public SpostaLottoControllerBase(String content, LotAssigmentDao lotAssigment, LotAssigmentShelvesDao shelvesAssigment, MagazzinoDao magazzinoDao, ShelfDao shelfDao) {
