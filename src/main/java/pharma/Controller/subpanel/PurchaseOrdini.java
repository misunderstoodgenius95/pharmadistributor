...
import pharma.DialogController.PurchaseOrderControllerBase;
...
public class PurchaseOrdini implements Initializable {
    ...
    public PurchaseOrdini(PurchaseOrderDao purchaseOrderDao, LottiDao lottiDao, PharmaDao pharmaDao) {
    ...
    public void btn_action_add(ActionEvent event) {
        ...
        PurchaseOrderControllerBase purchaseOrderHandler=new PurchaseOrderControllerBase(lottiDao,purchaseOrderDao,p_detail,s_update,pharmaDao);
