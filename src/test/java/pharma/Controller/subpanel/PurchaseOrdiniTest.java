...
private Database databaseMock;
  ...
  private PurchaseOrdini purchaseOrdini;


    @BeforeEach
    public void setUp() throws SQLException, IOException {
        // purchaseOrdini=new PurchaseOrdini(purchaseOrderDao,p_detail,lottiDao);
    ...
    public void start(Stage primaryStage) throws IOException, SQLException {
        ...
        purchaseOrdini = loader.getController();
...
//        purchaseOrdini.table_id.getItems().clear();
//
...
//purchaseOrdini.table_id.getItems().add(fieldData);
