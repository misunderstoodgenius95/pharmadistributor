...
public class PurchaseCreditNoteControllerBase extends DialogControllerBase<FieldData> {
    ...
    public PurchaseCreditNoteControllerBase(String content, FieldData fieldData_header, List<GenericJDBCDao> list) {
