...
class PharmacistHandlerCreateTest {
    ...
    public void test(FxRobot robot){
        ...
        Platform.runLater(()->{
           ...
           when(userGateway.register(anyString(),anyString(),anyString(),anyString(),anyString())).thenReturn(new UserGatewayResponse("",200));
            PharmacistControllerBaseCreate pharmacistHandlerCreate=new PharmacistControllerBaseCreate( farmaciaDao, userGateway);
