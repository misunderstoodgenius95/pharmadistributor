...
class StockEmergencyCalculatorTest {

    @ParameterizedTest
    @CsvSource({"500,100","30,10","100,100"})
    void calculateEmergencyLevel(int stock_qty,long expire) {
        System.out.println(StockEmergencyCalculator.calculateEmergencyLevel(stock_qty,expire));
    }
    ...
    public  void test(){
            double threshold=45;
            double daysUntilExpiration=100;
    ...
    @Test
        void testCalculateEmergencyLevel_NormalValues2() {
    ...
    @Test void  testCalculateEmergencyLevel_NormalValues3(){
    ...
    public void testCalculateExpirationUrgency(long days) {
