...
import pharma.DialogController.Table.LottoTableBase;
import pharma.DialogController.Table.TableBase;
import pharma.Service.ChoiceWarehouse;
import pharma.Service.OrdersPharmacist;
...
public class LottoStorageControllerBase extends DialogControllerBase<FieldData> {
    private static final Logger log = LoggerFactory.getLogger(LottoStorageControllerBase.class);
...
private ObjectProperty<LotAssigment> assigment_property;
    public LottoStorageControllerBase(String content, List<GenericJDBCDao> genericJDBCDao) {
