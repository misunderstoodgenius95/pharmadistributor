...
public class MagazzinoControllerBase extends DialogControllerBase<WarehouseModel> {
    ...
    public MagazzinoControllerBase(String content, List<GenericJDBCDao> genericJDBCDao, ObservableList<WarehouseModel> observableList) {
