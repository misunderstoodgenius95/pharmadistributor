...
public class SuggestPriceControllerBase extends DialogControllerBase<FieldData> {
    ...
    public SuggestPriceControllerBase(String content, SellerPriceDao sellerPriceDao, PriceSuggestion priceSuggestion, SimpleBooleanProperty s_boolean) {
