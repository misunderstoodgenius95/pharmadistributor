...
class LottiDialogControllerBaseTest {
    private FarmacoDao farmacoDao;
    private Database database;
    private LottiDao lottiDao;
    private LottiDialogControllerBase dialogHandler;
  ...
  private PreparedStatement preparedStatement;
    ...
    public void INvalidTest(FxRobot robot){
        Platform.runLater(()-> {
            ObservableList<FieldData> obs = FXCollections.observableArrayList();
            LottiDialogControllerBase dialogHandler = new LottiDialogControllerBase("Aggiungi Lotti", lottiDao, farmacoDao, obs);
    ...
    public void ValidInsertNotDataNotSelectable(FxRobot fxrobot){
        ...
        Platform.runLater(()-> {
            ObservableList<FieldData> obs = FXCollections.observableArrayList();
            dialogHandler = new LottiDialogControllerBase("Aggiungi Lotti", lottiDao, farmacoDao, obs);
