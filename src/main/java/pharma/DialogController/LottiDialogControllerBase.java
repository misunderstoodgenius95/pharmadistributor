...
public class LottiDialogControllerBase extends DialogControllerBase<FieldData> {
    ...
    public LottiDialogControllerBase(String content, LottiDao lottiDao, FarmacoDao farmacoDao, ObservableList<FieldData> observableList) {
