...
class SellerOrderHandlerTest {
    ...
    public void ValidtestWIthAll(FxRobot robot){
        ...
        when(s_dao.findByRangeBetweenAndRagioneSociale(any(Date.class),any(Date.class),anyString())).thenReturn(List.of(FieldData.FieldDataBuilder.getbuilder().setId(1).
                setProduction_date(Date.valueOf(LocalDate.of(2026,1,1))).
                setNome_casa_farmaceutica("Farmacia Lizzo").setTotal(40.11).
                build(),FieldData.FieldDataBuilder.getbuilder().setId(1).
                setProduction_date(Date.valueOf(LocalDate.of(2026,1,1))).
        ...
        Platform.runLater(()->{
            SellerOrderHandler sellerOrderHandler=new SellerOrderHandler("",s_dao,s_detail,s_invoice,s_credit,s_credit_detail);
