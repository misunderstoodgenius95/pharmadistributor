...
public class LottoStorageSearchHandler extends DialogHandler<FieldData> {
    ...
    public LottoStorageSearchHandler(String content, List<GenericJDBCDao> genericJDBCDao) {
