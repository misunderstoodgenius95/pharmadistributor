...
public class SuggestPromotionControllerBase extends DialogControllerBase<FieldData> {
    ...
    public SuggestPromotionControllerBase(String content, SellerPriceDao sellerPriceDao, PromotionHandler suggest, PromotionDao promotionDao, SimpleBooleanProperty s_boolean) {
        super(content, List.of(promotionDao));
        this.sellerPriceDao = sellerPriceDao;
        this.promotionHandler=suggest;
...
private void listener_choice() {
    ...
    private void listener_btn_choice(){
            ...
            double suggestion=promotionHandler.calculate_discount(id);
