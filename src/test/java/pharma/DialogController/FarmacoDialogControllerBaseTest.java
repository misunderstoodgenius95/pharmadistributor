...
class FarmacoDialogControllerBaseTest {
    ...
    public void ValidTestwithChoiceboxNotMockito(FxRobot robot) throws AccessException {
        Platform.runLater(()->{
            ...
            FarmacoDialogControllerBase farmacoDialogHandler=new FarmacoDialogControllerBase("Aggiungi Farmaco",obs_fieldData,farmacoDao,detailDao,pharmaDao);
            try {
