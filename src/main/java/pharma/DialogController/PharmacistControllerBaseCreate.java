...
public class PharmacistControllerBaseCreate extends DialogControllerBase<FieldData> {
    private TextField textField_email;
    private TextField textField_first_name;
    private TextField  textField_last_name;
    private UserGateway userGateway;
    public PharmacistControllerBaseCreate(FarmaciaDao farmaciaDao, UserGateway userGateway) {
    ...
    protected Status condition_event_status(FieldData type) throws Exception {
        ...
        UserGatewayResponse ur= userGateway.register_pharmacist(type.getEmail(),password,"pharmacist",type.getNome(),type.getLast_name(),type.getId());
