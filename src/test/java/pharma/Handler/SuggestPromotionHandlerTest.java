...
class SuggestPromotionHandlerTest {
    ...
    public void Validtest(FxRobot robot) {
        ...
        Platform.runLater(()->{
            when(promotionsSuggest.get_promotion_discount(anyInt())).thenReturn(10);
            SimpleBooleanProperty s_boolean=new SimpleBooleanProperty();
         SuggestPromotionHandler promotionHandler=new SuggestPromotionHandler("Promozione",sellerPriceDao,promotionsSuggest,promotionDao,s_boolean);
