...
public class AdminCreateCredentialsControllerBase extends DialogControllerBase<FieldData> {
    ...
    public AdminCreateCredentialsControllerBase(String content, UserGateway userGateway) {
        super(content, userGateway);
    ...
    protected Status condition_event_status(FieldData type) throws Exception {
        ...
        UserGatewayResponse ur= userGateway.register(type.getEmail(),password,type.getRole(),type.getNome(),type.getLast_name());
