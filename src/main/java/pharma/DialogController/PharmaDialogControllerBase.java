...
public class PharmaDialogControllerBase extends DialogControllerBase<FieldData> {
...
private SimpleObjectProperty<FieldData> fd_property;
    public PharmaDialogControllerBase(String dialog, PharmaDao pharmaDao, ObservableList<FieldData> obs) {
        super(dialog);
